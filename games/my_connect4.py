...
from typing import Final, Tuple, List, Callable

import numpy as np

from config import State, Action, player_symbols, Env, device, \
    EnvOutput, Actions
from games.gridboard_utils import rewards_all, rewards_winner_take_all, rewards_individual, \
    move_along_in_dirs, Empty, _hash, GridBoard, move_along_in_dir_pairs
...
def check_connected(grid: np.ndarray,
